...
template<typename T>
void subtract(const T& s1, const T& s2, T& result);
...
template< template<typename> typename T = Set, typename ItemType>
void unite(const T<ItemType>& s1, const T<ItemType>& s2, T<ItemType>& result)
{
...
template< template<typename> typename T = Set, typename ItemType>
void subtract(const T<ItemType>& s1, const T<ItemType>& s2, T<ItemType>& result)
{
